...
# pyflyte run --remote flow_4.py ADaM_TFL_QC --sdtm_dataset_snapshot /mnt/imported/data/snapshots/SDTMBLIND/1 --metadata_snapshot /mnt/data/snapshots/METADATA/1 
