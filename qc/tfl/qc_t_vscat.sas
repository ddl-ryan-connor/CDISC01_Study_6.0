...
* Purpose              : Create the QC Categorical Summary Table
* ____________________________________________________________________________
* DESCRIPTION                                                    
*                                                                   
...
proc report data = add_param_results_stat headline split = "*" style(report) = {width = 100% cellpadding = 3} out = tflqc.t_vscat;
        ...
        ** add footnotes describing the critical codes;
        ...
        footnote3 justify = left "Dataset(s): ADVS; Program: qc_t_vscat.sas; Output: qc_t_vscat.pdf; Generated on: &sysdate9 &systime";
run;
