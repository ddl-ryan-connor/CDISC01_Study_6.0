...
# pyflyte run --remote workflow_adam_new.py ADaM_NEW --sdtm_dataset_snapshot /mnt/imported/data/SDTMBLIND/33
...
def ADaM_NEW(sdtm_dataset_snapshot: str) # -> FlyteFile[TypeVar("sas7bdat")]:
    ...
    adsl = run_domino_job_task(
        ...
        dataset_snapshots=[DatasetSnapshot(Id="64e3c80427f0ef13b5d3a73c", Version=33)]
    )
